...
class PsColors {
  ...
  // static const Color _c_main_dark_color = Color(0xFFb33437);

   static const Color _c_main_color = Color(0xFFEA4C46);
 // static const Color _c_main_color = Color(0xFFD31A20);
  static const Color _c_main_light_color = Color(0xFFF1959B); //FFF0F1);
  static const Color _c_main_dark_color = Color(0xFFDC1C13);
 // static const Color _c_main_dark_color = Color(0xFFC81F23);
