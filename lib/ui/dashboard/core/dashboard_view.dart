...
import 'package:flutterbuyandsell/ui/ads/ads_page.dart';
  ...
  int getBottonNavigationIndex(int param) {
    ...
    switch (param) {
      case PsConst.REQUEST_CODE__MENU_HOME_FRAGMENT:
        index = 1;
        break;
      case PsConst.REQUEST_CODE__PLACE_ADS:
        index = 2;
        break;
        /*case PsConst.REQUEST_CODE__DASHBOARD_CATEGORY_FRAGMENT:
        index = 2;
        break;*/
       case PsConst.REQUEST_CODE__ADS_DATA:
        index = 3;
        break;
    ...
    debugPrint("Changed indedx : $index");
    return index;
  }
  ...
  dynamic getIndexFromBottonNavigationIndex(int param) {
    ...
    switch (param) {
      case 0:
        ...
        break;
      case 1:
        index = PsConst.REQUEST_CODE__PLACE_ADS;
        ...
        break;*/
      case 2:
        index = PsConst.REQUEST_CODE__ADS_DATA;
        title = 'Ads';
        /*(psValueHolder == null ||
...
*/
                Navigator.push<MaterialPageRoute>(
                    context,
                    MaterialPageRoute(
                      builder: (BuildContext context) => HomeItemSearchView(
        ...
        bottomNavigationBar: _currentIndex ==
                ...
                _currentIndex == PsConst.REQUEST_CODE__ADS_DATA||
                _currentIndex == PsConst.REQUEST_CODE__PLACE_ADS
                ...
                child: JumpingTabBar(
                  ...
                  onChangeTab: (int index) {
                    ...
                    final dynamic _returnValue =
                        getIndexFromBottonNavigationIndex(index - 1);

                    updateSelectedIndexWithAnimation(
                        _returnValue[0], _returnValue[1]);
                  },
                  selectedIndex: getBottonNavigationIndex(_currentIndex),
                  items: [
                    TabItemIcon(
                      iconData: Icons.store,
                      startColor: PsColors.mainDarkColor,
                      curveColor: PsColors.mainLightColor,
                    ),
                    TabItemIcon(
        ...
        body: ChangeNotifierProvider<NotificationProvider>(
          ...
          child: Builder(
            builder: (BuildContext context) {
              debugPrint("_curtrentIndex:- $_currentIndex");
              if (_currentIndex ==
                  PsConst.REQUEST_CODE__DASHBOARD_CATEGORY_FRAGMENT) {
                return CategoryListView();
              } else if(_currentIndex == PsConst.REQUEST_CODE__ADS_DATA){
                return AdsPage();
              } else if(_currentIndex == PsConst.REQUEST_CODE__PLACE_ADS){
...
class _CallLoginWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Stack(
      children: <Widget>[
        Container(
          // Color of login screen would be changed from here
  ...
  Path getClip(Size size) {
    ...
    Path path = Path()
      ...
      ..arcTo(Rect.fromLTRB(0, size.height - radius, radius, size.height),
          0.5 * pi, 0.5 * pi, false)
      ..lineTo(0, radius)
      ..arcTo(Rect.fromLTWH(0, 0, 70, 40), 1 * pi, 1 * pi, false)
      ..close();
    return path;
  }
