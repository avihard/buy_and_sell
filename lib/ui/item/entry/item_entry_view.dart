        ...
        showDialog<dynamic>(
            ...
            builder: (BuildContext context) {
              return SuccessDialog(
                ...
                onPressed: () {
                  userInputListingTitle.clear();
                  userInputBrand.clear();
                  userInputHighLightInformation.clear();
                  userInputDescription.clear();
                  userInputDealOptionText.clear();
                  userInputLattitude.clear();
                  userInputLongitude.clear();
                  userInputAddress.clear();
